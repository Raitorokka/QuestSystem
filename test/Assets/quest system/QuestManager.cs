...
public class QuestManager
{
    ...
    public static float AIInitialHeight;
    ...
    public static void Init()
    {
        ...
        AIInitialHeight = QuestMark.preferredHeight;
    ...
    {
        if (QuestMark.preferredHeight > AIInitialHeight)
        {
            float h = (QuestMark.preferredHeight - AIInitialHeight) / 24;
